...
/// Members are the log of the absolute value and the sign (+1, -1 or 0)
    class LogAndSign
    {
        ...
        public:
            ...
            void change_sign()                              ///< change sign
            {
                sign_val = -sign_val;
            }
            Real LogValue() const { return log_val; }
            Real log_value() const                          ///< log of the absolute value
            {
                return log_val;
            }
            int Sign() const { return sign_val; }
            int sign() const                                ///< sign of the value
            {
                return sign_val;
            }
...
// updated names
            ...
            void protect()                                  // cannot delete or reuse
            {
                tag_val=-1;
            }
            void Protect()                                  // cannot delete or reuse
            ...
            void release_and_delete()                       // delete matrix after use
            {
                tag_val=0;
            }
...
///< return the size of the array
            ...
            const int* Data() const                         ///< pointer to the data
            {
                return a;
            }
            int* data()                                     ///< pointer to the data
            ...
            const int* const_data() const                   ///< pointer to the data
            {
                return a;
            }
...
///< change length, keep data
            void cleanup()                                  ///< set length to zero
            {
                resize(0);
            }
            void CleanUp()                                  ///< set length to zero
